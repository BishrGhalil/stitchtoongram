# This file is part of stitchtoongram.
...
def version_helper():
    if __release__:
        version_string = "stitchtoongram {0}".format(__version__)
    else:
        import subprocess

        version_string = "stitchtoongram-master {0}"
        try:
...
# Constants
stitchtoongram = os.path.dirname(__file__)
DEFAULT_PAGER = "less"
